...
public partial class AddMagazine : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            String us = Convert.ToString("user");
            conn.Open();
            SqlCommand cmd = new SqlCommand("insert into Events values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + us + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','Yes')", conn);
